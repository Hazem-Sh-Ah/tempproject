...
def clone_model(model, custom_objects={}):
    ...
    # Create a new model instance based on the original model's class
    cloned_model = Sequential()  # or use any other type of model like Functional Model if needed
    ...
    for layer_config in config['layers']:
        ...
        # Check if custom objects are needed for layers
        if layer_class in custom_objects:
    ...
    # Set the weights of the cloned model to match the original model's weights
